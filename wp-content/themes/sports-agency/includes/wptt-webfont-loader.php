...
if ( ! class_exists( 'Sports_Agency_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Sports_Agency_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'sports_agency_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function sports_agency_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Sports_Agency_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'sports_agency_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function sports_agency_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Sports_Agency_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
